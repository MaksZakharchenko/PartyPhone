...
public class GameMan : MonoBehaviourPunCallbacks
{
    ...
    void Start()
    {
        ...
        Vector3 pos1 = new Vector3(-8f, 13f, 0f);
        Vector3 pos2 = new Vector3(-2f, 13f, 0f);
        Vector3 pos3 = new Vector3(4f, 13f, 0f);
        Vector3 pos4 = new Vector3(10f, 13f, 0f);
        Vector3 pos5 = new Vector3(16f, 13f, 0f);
